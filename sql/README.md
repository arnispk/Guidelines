...
- [2. Naming conventions](#2-naming-conventions)
  ...
  - [2.3 Columns](#23-columns)
  - [2.4 Aliasing or correlations](#24-aliasing-or-correlations)
  - [2.5 Stored procedures](#25-stored-procedures)
  - [2.6 Uniform suffixes](#26-uniform-suffixes)
- [3. Query syntax](#3-query-syntax)
  - [3.1 Reserved words](#31-reserved-words)
  - [3.2 White space](#32-white-space)
  - [3.3 Indentation](#33-indentation)
  - [3.4 Preferred formalisms](#34-preferred-formalisms)
- [4. Create syntax](#4-create-syntax)
  - [4.1 Choosing data types](#41-choosing-data-types)
  - [4.2 Specifying default values](#42-specifying-default-values)
  - [4.3 Constraints and keys](#43-constraints-and-keys)
  - [4.4 Designs to avoid](#44-designs-to-avoid)
- [5. Appendix](#5-appendix)
  - [5.1 Reserved keyword reference](#51-reserved-keyword-reference)
